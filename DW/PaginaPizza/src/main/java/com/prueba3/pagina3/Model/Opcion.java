...
/**
 * Entidad que representa una Pizza en el catálogo
 *
 * Esta clase mapea la tabla de opciones (pizzas) disponibles en la base de datos
 * y define los atributos de cada pizza como nombre, descripción y precios por tamaño.
 */
@Entity
public class Opcion {
    @Id
