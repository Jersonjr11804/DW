...
/**
 * Controlador principal para la gestión de pizzas, carrito de compras,
 * registro, autenticación, pagos y usuarios.
 */
@Controller
public class OpcionController {
    ...
    public String confirmarPedido(Model model, RedirectAttributes redirectAttributes, HttpSession session) {
        ...
        if (usuarioEmail == null) {
            ...
            session.setAttribute("redirectAfterLogin", "/confirmar");
